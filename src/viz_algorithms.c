 ...
 * We based this on the Trie team design document V1.0
 * Please also consult our (the support tools) design document for a more thorough overview of our visulizations.
